...
struct abc : public Unit {
    // declare state variables here.
};

//function declarations 
static void abc_next(abc* unit, int inNumSamples);
static void abc_Ctor(abc* unit);
...
void abc_next(abc* unit, int inNumSamples) {
